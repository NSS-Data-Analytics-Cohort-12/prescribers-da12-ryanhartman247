...
-- WHERE LOWER(specialty_description) LIKE '%pain management%'
-- GROUP BY 1
-- ORDER BY 2 
...
-- SELECT 
-- 	'Total' AS speciality_description, 
...
-- Answer: It groups by all possibilities 
...
-- Answer: whichever veriable comes first is sorted by first in an alternating fashion
...
--Answer: This also includes the total without the second variable. This is my favorite one. 
...
-- 	CREATE EXTENSION tablefunc; - ALREADY RAN 
